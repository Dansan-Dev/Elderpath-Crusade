...
- ElderpathCrusade.app (the application bundle)
- README.md (this file)


## Quick start
1) Extract the ZIP to a folder you control (for example: Desktop/ElderpathCrusade-mac/).
2) Double‑click ElderpathCrusade.app to start the game.
...
If you see a message like “ElderpathCrusade.app cannot be opened because it is from an unidentified developer”:
- Method A (recommended):
  1) Control‑click (right‑click) ElderpathCrusade.app
  2) Choose “Open”
  3) In the dialog, click “Open” again
- Method B (from System Settings):
  1) Try to open the app once so the warning appears
  2) Open System Settings → Privacy & Security
  3) Scroll to “Security” and click “Open Anyway” for ElderpathCrusade
...
- Drag ElderpathCrusade.app into the Applications folder to keep it with your other apps.
...
## Updating the game
- Download the new ZIP, extract it, and replace the old ElderpathCrusade.app in Applications or your chosen folder.
...
- A copy of this README is also placed inside the app bundle at: ElderpathCrusade.app/Contents/MacOS/README.md
