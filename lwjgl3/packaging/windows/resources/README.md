...
- ElderpathCrusade.exe (the application)
- Game runtime files and assets required to play
- README.md (this file)


## Quick start
1) Extract the ZIP to a folder you control (for example: Desktop\ElderpathCrusade-windows-x64\).
2) Double‑click ElderpathCrusade.exe to start the game.
...
## Creating shortcuts
- Desktop shortcut:
  1) Right‑click ElderpathCrusade.exe
...
- Pin to taskbar:
  1) Drag the ElderpathCrusade.exe file onto the taskbar
...
- If double‑clicking does nothing, try running ElderpathCrusade.exe from a Command Prompt to see error messages.
